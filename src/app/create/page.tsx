    ...
    return (
        <div className="flex min-h-screen flex-col items-center p-6 bg-zinc-950 relative overflow-hidden">
            ...
            <main className="max-w-md w-full space-y-8 relative z-10">
                <Link href="/" className="flex items-center text-zinc-500 hover:text-emerald-400 transition-colors font-mono text-sm group w-fit">
                    <ArrowLeft className="w-4 h-4 mr-2 group-hover:-translate-x-1 transition-transform" />
                    VOLVER
                </Link>

                <div className="space-y-1">
                    <h1 className="text-4xl font-black text-white tracking-tight">Nuevo Gasto</h1>
